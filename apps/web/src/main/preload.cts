...
const api = {
  ...
  fetchThreadByRun: (runId: string) => ipcRenderer.invoke(IPC_CHANNELS.fetchThreadByRun, runId),
  fetchThreadMessages: (threadId: string) => ipcRenderer.invoke(IPC_CHANNELS.fetchThreadMessages, threadId),
  fetchUserPrompts: (runId: string) => ipcRenderer.invoke(IPC_CHANNELS.fetchUserPrompts, runId),
  answerUserPrompt: (input: unknown) => ipcRenderer.invoke(IPC_CHANNELS.answerUserPrompt, input),
  getFollowUpSuggestions: (input: unknown) => ipcRenderer.invoke(IPC_CHANNELS.getFollowUpSuggestions, input),
  executeFollowUp: (input: unknown) => ipcRenderer.invoke(IPC_CHANNELS.executeFollowUp, input),
